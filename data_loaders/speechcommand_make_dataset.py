...
parser.add_argument('--gcommads_fold', default='../data/speechcommand_dataset/', help='the path to the root folder of te google commands dataset.')
parser.add_argument('--out_path', default='../data/speechcommand_dataset', help='the path where to save the files splitted to folders.')
